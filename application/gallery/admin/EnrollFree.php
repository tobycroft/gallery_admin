...
class EnrollFree extends Admin
{
    ...
    public function index()
    {
        ...
        $map = $this->getMap();
        // 读取用户数据
        $data_list = EnrollModel::alias('a')->field('a.*,b.rating,b.attachment')->leftJoin(['g_enroll_upload' => 'b'], 'a.enroll_id=b.id')->where($map)->where("source", "free")->order($order)->paginate()->each(function ($item) {
//            $item['attachment'] = '';
